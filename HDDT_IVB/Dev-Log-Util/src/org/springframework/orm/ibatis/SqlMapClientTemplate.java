...
public class SqlMapClientTemplate extends JdbcAccessor implements SqlMapClientOperations {
	private static final Log log = LogFactory.getLog(SqlMapClientTemplate.class);
	...
	private void writeLog(String statementName) {
		System.out.println("[SQLMAPID]     : " + "**************************** " + statementName);
	}
