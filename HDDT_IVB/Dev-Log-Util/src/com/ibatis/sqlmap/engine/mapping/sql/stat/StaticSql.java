...
import com.ibatis.sqlmap.engine.mapping.sql.PrettyStringBuilder;
...
public class StaticSql implements Sql {
	...
	public String getSql(StatementScope statementScope, Object parameterObject) {
		System.out.println("[SQL MAP FILE] : " + "**************************** "
				+ statementScope.getParameterMap().getResource());
		System.out.println("[SQL STATEMENT]: " + "**************************** "
				+ new PrettyStringBuilder().toStringVisible(sqlStatement.trim()));
		System.out.println("[SQL PARAMETER]: " + "**************************** "
				+ new PrettyStringBuilder().toString(parameterObject) + "\n");
		return sqlStatement;
	}
